...
async function main(){
  ...
  const detail=await request('/chart/-200');assert.equal(detail.status,200);assert.equal(detail.data.name,'Targeted');
  ...
  console.log('PASS instance visibility: all/single/multiple/none, verified UID, spoofing, cache, search, pagination, resources, private scores and unique IDs');
}
